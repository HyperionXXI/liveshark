...
\texttt{universe} field from ArtDMX. For sACN, it is the big-endian \texttt{universe} field from the framing layer.
The report uses this canonical value; the same universe means identical numeric values across protocols.
...
\begin{itemize}
  ...
  \item If a payload provides fewer than 512 slots, missing slots are padded with 0 for that frame.
