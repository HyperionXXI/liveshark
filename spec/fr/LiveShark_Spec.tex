...
La capture en direct / l'analyse en ligne est un objectif futur explicite et \PEUT{} être implémentée une fois le cÅ“ur hors ligne validé.
...
\paragraph{Métriques diagnostiques supplémentaires v0.2}
Ces champs sont des ajouts optionnels du schéma de rapport v0.2 ; les consommateurs v0.1 restent compatibles en ignorant les champs inconnus.
\begin{itemize}
...
Le cÅ“ur \DOIT{} exposer une abstraction d’entrée paquets/événements afin que l’analyse puisse être alimentée par :
...
\begin{itemize}
  \item \texttt{report\_version} : entier (version de sch?ma ; v0.1 = 1, v0.2 = 2).
