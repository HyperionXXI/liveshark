...
\title{\sffamily\bfseries\color{LSBlue}LiveShark\\\large Spécification (PDF imprimable)}
...
\begin{itemize}
  ...
  \item Reconstruction de trames DMX (512 slots) et métriques (fps, pps/bps, jitter).
