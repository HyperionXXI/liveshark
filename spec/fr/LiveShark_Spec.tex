...
\begin{itemize}
  \item \textbf{pps/bps :} paquets/octets par seconde, moyennés sur la durée de capture quand elle est disponible ; unités paquets/s et octets/s. Si la durée est inconnue, les valeurs sont omises.
...
\begin{itemize}
  ...
  \texttt{loss\_rate} est \texttt{loss\_packets / (loss\_packets + frames\_count)} pour les trames suivies par séquence. Si les numéros de séquence sont indisponibles, les champs de perte \DOIT{} être omis.
