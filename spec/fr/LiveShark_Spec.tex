...
\texttt{universe} en little-endian d'ArtDMX. Pour sACN, c'est le champ \texttt{universe} en big-endian de la couche de framing.
Le rapport utilise cette valeur canonique ; un même univers signifie des valeurs numériques identiques entre protocoles.
